...
Vue.component('galeria-c', {
    ...
    template: `<section id="info"> 
                <article class="bg-light">
                    ...
                    <h2 class="mb-5 pt-3 pb-3 text-center" v-once>{{h2_galeria}}</h2>
                ...
                <article class="bg-light pt-4">
                    <h2 class="mb-5 pt-3 pb-3 text-center" v-once>{{h2_integrantes}}</h2>
                    <div class="container">
...
Vue.component('tienda-c', {
    data:function(){
		return {
			tienda:[
                {url:"img/tienda/newsoftheworld.jpg", title:"News of the World", precio: '$1200'},
				{url:"img/tienda/freddie.jpg", title:"Freddie Mercury", precio: '$1800'},
				{url:"img/tienda/brian.jpg", title:"Brian May", precio: '$1800'},
				{url:"img/tienda/john.jpg", title:"John Deacon", precio: '$1800'},
				{url:"img/tienda/roger.jpg", title:"Roger Taylor", precio: '$1800'},
				{url:"img/tienda/flash_gordon.png", title:"Queen Flash Gordon", precio: '$1200'},
				{url:"img/tienda/freddie_wembley.jpg", title:"Freddie en Wembley", precio: '$1500'},
				{url:"img/tienda/nombres.jpg", title:"Nombres de Queen", precio: '$1400'},
				{url:"img/tienda/sudamerica_81.jpg", title:"Queen gira Sudamerica 81'", precio: '$1250'},
				{url:"img/tienda/thegame.png", title:"Queen The Game", precio: '$1300'},
				{url:"img/tienda/queen_opera.jpg", title:"Queen Opera", precio: '$1200'},
				{url:"img/tienda/queen_vintage.jpg", title:"Queen vintage", precio: '$1500'},
			],
		}
	},
    sheet: false,
    template: `<section class="bg-light">
				<div class="container">
                    ...
                    <v-alert type="success" id="alerta" class="d-none">
                    </v-alert>

                    <div id="mostrar">
                    </div>

                    <div class="text-center d-none" id="pagar">
                        <v-progress-circular
                        indeterminate
                        color="primary"
                        ></v-progress-circular>
                    ...
                    <v-alert type="success" id="exitosa" class="d-none">
                    </v-alert>

					<div class="row">
						<div class="col-sm-6 col-md-4 col-lg-3 pb-4" v-for="img in tienda">
							<div class="card">
								<img class="card-img-top img" :src="img.url" :alt="img.title" :title="img.title">
									<div class="card-body text-center">
                                        <form name="form" class="form" method="post">
											<h5 class="card-title">{{ img.title }}</h5>
											<p class="card-text">{{ img.precio }}</p>
                                            <input type="hidden" class="url" name="url" :value="img.url">
                                            <input type="hidden" class="title" name="title" :value="img.title">
                                            <input type="hidden" class="precio" name="precio" :value="img.precio">
                                            <v-btn type="submit" class="enviar" depressed color="primary">Comprar</v-btn>
                                        </form>
									</div>
							</div>
						</div>
                        ...
                        <aside>
                            <div class="bg-light">
                                ...
                                <div class="row justify-content-center">  
                                    ...
                                    <form action="index.html" method="post" enctype="multipart/form-data" name="formC" class="mb-5 pb-5" id="formC">

                                        <div class="form-group">
                                            <label for="nombre">Nombre</label>
                                            <input class="form-control" type="text" name="nombre" id="nombre" placeholder="Escriba su nombre..." autocomplete="off" required/>
                                        </div>

                                        <div class="form-group">
                                        <label for="apellido">Apellido</label>
                                        <input class="form-control" type="text" name="apellido" id="apellido" placeholder="Escriba su apellido..." autocomplete="off" required/>
                                        </div>
...
const Home = { template: '<home-c></home-c>'}
const Galeria = { template: '<galeria-c></galeria-c>'}
const Tienda = { template: '<tienda-c></tienda-c>' }
const Contacto = { template: '<contacto-c></contacto-c>' }
